...
export const About = () => {
  return (
    ...
    >
      <div className="mx-auto grid max-w-4xl grid-cols-2 gap-x-5">
        <div
        ...
        >
          <Text>
            ...
            <span className="text-white">Angko</span> and I enjoy Build
            Something. My interest in web and apps development started back in
            2014.
          </Text>
          <Text>
